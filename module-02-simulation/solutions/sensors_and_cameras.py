"""Solution - Lesson 2.8: declaring sensors and rendering cameras.

Self-contained. Run:  python sensors_and_cameras.py [layout|episode|render|timing|all]
...
def beside(name, path=None):
    ...
    only `module-*/solutions/*.png` is gitignored.
    """
...
def read(data, name):
    ...
    return np.array(data.sensor(name).data)
