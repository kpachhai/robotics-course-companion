...
def randomise_appearance(model, rng):
    ...
    # TODO(you): perturb model.mat_rgba for cube_mat / table_mat / bin_mat,
    # model.light_pos and model.light_diffuse for the "key" light, and
    # model.cam_pos for the "overhead" camera. Nothing here touches a mass,
    # a friction or a gain, which is the whole point of the experiment.
